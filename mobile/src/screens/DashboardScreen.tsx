...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: 16, paddingTop: 14, width: "100%", maxWidth: 760, alignSelf: "center" },
  heroCard: {
    marginTop: 14,
    minHeight: 170,
  ...
  heroGlowOne: { position: "absolute", width: 190, height: 190, borderRadius: 95, backgroundColor: "rgba(91,91,214,0.12)", top: -104, right: -60 },
  heroGlowTwo: { position: "absolute", width: 145, height: 145, borderRadius: 73, backgroundColor: "rgba(18,184,166,0.10)", bottom: -92, left: -58 },
  heroTopRow: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: 12 },
  heroEyebrow: { fontFamily: fonts.bodySemiBold, fontSize: 9.5, letterSpacing: 1.2, color: colors.primary },
  heroName: { fontFamily: fonts.display, fontSize: 23, color: colors.textPrimary, letterSpacing: -0.6, marginTop: 6 },
  heroMeta: { fontFamily: fonts.body, fontSize: 11, color: colors.textSecondary, marginTop: 4 },
  healthBadge: { flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: colors.successSoft, paddingHorizontal: 9, paddingVertical: 6, borderRadius: radii.pill, borderWidth: 1, borderColor: colors.successSoft },
  healthDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: colors.cyan },
  healthText: { fontFamily: fonts.bodySemiBold, color: colors.success, fontSize: 10 },
  heroBottomRow: { flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between", marginTop: "auto" },
  heroNumber: { fontFamily: fonts.mono, fontSize: 34, color: colors.textPrimary },
  heroNumberLabel: { fontFamily: fonts.body, fontSize: 10.5, color: colors.textSecondary, marginTop: 2 },
  heroWave: { opacity: 0.9, marginBottom: 6 },
  metricsGrid: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginTop: 12 },
  metricCard: { width: "48.5%", minHeight: 122, marginBottom: 10, padding: 15 },
  metricIcon: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  metricValue: { fontFamily: fonts.mono, fontSize: 27, color: colors.textPrimary, marginTop: 12 },
  metricLabel: { fontFamily: fonts.bodyMedium, fontSize: 11, color: colors.textSecondary, marginTop: 3 },
  sentimentCard: { padding: 18, marginTop: 4 },
  ...
  actionPlanCard: { padding: 18, marginTop: 12, borderColor: colors.primarySoft },
  actionPlanHeader: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
