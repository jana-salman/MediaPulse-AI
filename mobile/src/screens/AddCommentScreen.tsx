...
const styles = StyleSheet.create({
  ...
  resultsTitle: { fontWeight: "600", marginBottom: 10, color: colors.textPrimary },
  resultRow: {
    flexDirection: "row",
  ...
  resultText: { flex: 1, fontSize: 13, color: colors.textPrimary, marginRight: 8 },
  resultStatus: { fontSize: 12, fontWeight: "600", color: colors.textSecondary, textTransform: "capitalize" },
});
